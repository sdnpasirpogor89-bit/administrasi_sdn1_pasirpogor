      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-red-50 dark:bg-red-900/20">
            <tr>
              <th className="px-4 sm:px-6 py-3 text-left text-sm font-semibold text-red-800 dark:text-red-300 border-b border-red-200 dark:border-red-800">
                Hari
              </th>
              <th className="px-4 sm:px-6 py-3 text-left text-sm font-semibold text-red-800 dark:text-red-300 border-b border-red-200 dark:border-red-800">
                Jam Ke
            ...
            {days.map((day) => {
              ...
              return daySchedules.map((schedule, idx) => {
                ...
                return (
                  <tr
                    key={schedule.id}
                    className="border-b border-slate-200 dark:border-slate-700 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors">
                    {idx === 0 && (
                      <td
                    ...
                    <td className="px-4 sm:px-6 py-4">
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 flex items-center gap-2 text-sm px-3 py-2 rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors min-h-[44px]">
                          <Edit className="w-4 h-4" />
                          <span className="hidden sm:inline">Edit</span>
                        </button>
                        <button
                          onClick={() => handleDelete(schedule.id)}
                          className="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 flex items-center gap-2 text-sm px-3 py-2 rounded-md hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors min-h-[44px]">
                          <Trash2 className="w-4 h-4" />
        ...
        <div className="mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-slate-200 dark:border-gray-700 p-4 sm:p-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-100 dark:bg-red-900/20 rounded-lg flex items-center justify-center">
              <Calendar className="w-6 h-6 sm:w-7 sm:h-7 text-red-600 dark:text-red-400" />
            </div>
            <div>
        ...
        <div className="mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-slate-200 dark:border-gray-700 p-3 sm:p-4">
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              ...
              className={`flex-1 min-w-[140px] px-3 sm:px-4 py-3 rounded-lg font-medium flex items-center gap-2 justify-center border transition-all ${
                viewMode === "grid"
              ...
              <span className="hidden sm:inline">Tampilan Grid</span>
            ...
            <button
              ...
              <span className="hidden sm:inline">Tampilan List</span>
              <span className="sm:hidden">List</span>
            </button>
            <button
              onClick={() => handleOpenModal()}
              className="flex-1 min-w-[140px] bg-red-600 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-600 text-white px-3 sm:px-4 py-3 rounded-lg font-medium flex items-center gap-2 justify-center border border-red-700 dark:border-red-600 transition-all">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-4 sm:p-6 border-b border-slate-200 dark:border-gray-700">
              ...
              <button
                ...
                className="text-slate-400 dark:text-gray-500 hover:text-slate-600 dark:hover:text-gray-400 transition-colors p-2 rounded-full hover:bg-slate-100 dark:hover:bg-gray-700 min-w-[44px] min-h-[44px] flex items-center justify-center">
                <X className="w-6 h-6" />
              </button>
            </div>
            <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
              <div>
                ...
                <select
                  ...
                  required
                  className="w-full px-3 py-2 border border-slate-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-600 focus:border-red-500 dark:focus:border-red-600 bg-white dark:bg-gray-700 text-slate-900 dark:text-white">
                  {days.map((day) => (
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                <button
                  ...
                  onClick={handleCloseModal}
                  disabled={loading}
                  className="flex-1 px-4 py-3 bg-slate-200 dark:bg-gray-700 hover:bg-slate-300 dark:hover:bg-gray-600 disabled:bg-slate-100 dark:disabled:bg-gray-800 text-slate-700 dark:text-gray-300 rounded-lg font-medium transition-colors">
                  Batal
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 px-4 py-3 bg-red-600 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-600 disabled:bg-red-400 dark:disabled:bg-red-800 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
                  {loading ? (
                    <>
