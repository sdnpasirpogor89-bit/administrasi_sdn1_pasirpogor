...
export default function ClassesPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 p-3 sm:p-4 md:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center justify-center h-64">
            ...
            <p className="mt-4 text-sm sm:text-base text-gray-600 dark:text-slate-300">
              Memuat data kelas...
            </p>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 p-3 sm:p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/40 rounded-lg shadow-md p-4 sm:p-5 lg:p-6 border border-blue-200 dark:border-blue-700">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-900/40 rounded-lg shadow-md p-4 sm:p-5 lg:p-6 border border-green-200 dark:border-green-700">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-900/40 rounded-lg shadow-md p-4 sm:p-5 lg:p-6 border border-purple-200 dark:border-purple-700 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center justify-between">
              <div>
        ...
        <div className="block lg:hidden space-y-3 sm:space-y-4">
          {classes.length === 0 ? (
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-8 text-center">
              <School className="w-12 h-12 text-gray-400 dark:text-slate-500 mx-auto mb-3" />
            ...
            classes.map((cls, index) => (
              <div
                ...
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300 px-3 py-1 rounded-full flex items-center gap-1.5 flex-shrink-0 ml-2">
                ...
                <div className="flex gap-2 pt-3 border-t border-gray-100">
                  <div className="flex-1 bg-green-50 dark:bg-green-900/40 rounded-lg p-2.5 text-center">
                  ...
                  <div className="flex-1 bg-pink-50 dark:bg-pink-900/40 rounded-lg p-2.5 text-center">
                    <div className="text-xs text-pink-700 dark:text-pink-300 font-medium mb-1">
                      Perempuan
                    </div>
                    <div className="text-lg sm:text-xl font-bold text-pink-600 dark:text-pink-300">
                      {cls.jumlahPerempuan}
                    </div>
                  </div>
                </div>
                    ...
                    <tr
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <School className="w-4 h-4 text-gray-400 dark:text-slate-500" />
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-medium bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300">
                          <Users className="w-3.5 h-3.5" />
                          {cls.jumlahSiswa}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-medium bg-pink-100 dark:bg-pink-900/40 text-pink-800 dark:text-pink-300">
                          <UserCheck className="w-3.5 h-3.5" />
                          {cls.jumlahPerempuan}
                        </span>
                      </td>
        ...
        {/* Footer Info */}
        <div className="mt-3 sm:mt-4 text-xs sm:text-sm text-gray-500 dark:text-slate-400 text-center">
